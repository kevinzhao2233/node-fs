...
import { chunkUploader, createTransmission,
  findTransmissionDetail, isFileExist, mergeChunks, quickUpload, removeFile, upload, uploader } from '../controller/transmission';
...
router.post('/quick-upload', quickUpload);
